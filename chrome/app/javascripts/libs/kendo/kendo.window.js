...
(function($, undefined) {
    ...
    templates = {
        wrapper: function() { return "<div class='k-widget k-window' />" },
        action: function() { return 
            "<a href='\\#' class='k-window-action k-link'>" +
                "<span class='k-icon k-close'>close</span>" +
            "</a>" },
        titlebar: function() { return 
            "<div class='k-window-titlebar k-header'>&nbsp;" +
                "<span class='k-window-title'>Customize</span>" +
        ...
        overlay: function() { return  "<div class='k-overlay' />" },
        contentFrame: function() { return 
        ...
        ,
        resizeHandle: function() { return "<div class='k-resize-handle k-resize-#= data #'></div>" }
    };
