...
(function() {
  ...
  define('mylibs/customize/customize',['jQuery', 'Kendo', 'text!mylibs/customize/views/customize.html', 'libs/webgl/glfx.min'], function($, kendo, template) {
...
(function() {
  ...
  define('libs/webgl/effects',['jQuery', 'Kendo', 'libs/face/ccv', 'libs/face/face'], function($, kendo) {
...
(function() {
  ...
  define('mylibs/utils/utils',['jQuery', 'Kendo', 'mylibs/utils/BlobBuilder.min'], function($, kendo) {
...
(function() {
  ...
  define('mylibs/share/share',['jQuery', 'Kendo', 'mylibs/utils/utils', 'text!mylibs/share/views/tweet.html'], function($, kendo, utils, template) {
...
(function() {
  ...
  define('mylibs/pictures/pictures',['jQuery', 'Kendo', 'mylibs/file/file', 'mylibs/share/share', 'text!mylibs/pictures/views/picture.html'], function($, kendo, file, share, picture) {
    var $container, pub;
    $container = {};
    return pub = {
      init: function(containerId) {
    ...
    update = function() {
      ...
      if (!paused) {
        ...
        if (preview.kind === "face") {
          return preview.filter(canvas, element);
        } else {
          return preview.filter(webgl, element, frame);
        }
      }
    };
    return pub = {
...
(function() {
  ...
  define('mylibs/preview/selectPreview',['jQuery', 'Kendo', 'libs/webgl/effects', 'mylibs/utils/utils', 'text!mylibs/preview/views/selectPreview.html'], function($, kendo, effects, utils, template) {
    ...
    height = 150;
    update = function() {
      var element, preview, _i, _len, _results;
      if (!paused) {
        if (window.HTML5CAMERA.IS_EXTENSION) {
          ctx.drawImage(window.HTML5CAMERA.canvas, 0, 0, width, height);
          element = canvas;
        ...
        for (_i = 0, _len = previews.length; _i < _len; _i++) {
          ...
          frame++;
          if (preview.kind === "face") {
            _results.push(preview.filter(preview.canvas, element));
          } else {
            _results.push(preview.filter(preview.canvas, element, frame));
          }
        }
        return _results;
      }
